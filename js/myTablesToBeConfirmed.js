...
function getTableData() {
    console.log("http://evening-thicket-5124.herokuapp.com/credentialService/getMyTablesToBeConfirmed?userid=" + $.session.get('userHash'))
    $.ajax(
            {
