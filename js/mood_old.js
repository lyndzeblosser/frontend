...
function getInvitations()
{
    ...
    if ($.session.get('userHash') === undefined) {
        ...
        return $.ajax({
            url: "http://evening-thicket-5124.herokuapp.com/credentialService/getInvitations?userid=" + $.session.get('userHash'),
            async: false,
            dataType: "json"
        });
    }
...
function getUserTable()
{
    if ($.session.get('userHash') === undefined) {
        ...
        return $.ajax({
            url: "http://evening-thicket-5124.herokuapp.com/credentialService/getUserTable?userid=" + $.session.get('userHash'),
            async: false,
            dataType: "json"
        });
    }
