...
function prepareTableDiv(table) {
    ...
    var html = "<div class=\"ui-grid-b\" style=\"padding:0px; margin:0px; border: solid 1px #cc0000\" > <div class=\"ui-block-a\" style=\"width:30%; margin:0px; padding:0px\" id=\"pendingimg\"><div class=\"ui-bar ui-bar-a\" style=\"margin:0px; padding:none;\"><img src=\"" + user['image'] + "\" class=\"pendimg\" ></div></div> <div class=\"ui-block-b\" style=\"width:50%;\"><div class=\"ui-bar ui-bar-a text\">Location: " + user['location'] + "<a href=\"view.html?tableid=" + table['tableid'] + "&user_from=" + table['user_from'] + "\" target=_self style=\"display: block; color:#cc0000; padding-right: 0em; padding-left: 0em; font-size: 11px;\">Go to confirmation screen</a></p>" + user['tags'] + "</div></div> <div class=\"ui-block-c\" style=\"width:20%;\"><div class=\"ui-bar ui-bar-a\" style=\"border:1px dotted #cc0000;\"><ul data-role=\"listview\" data-inset=\"true\"> <li style=\"height:20px;\"><img src=\"images/mycheck.png\" class=\"ui-li-icon ui-icon-check\"><span class=\"ui-li-count\">" + user['accepts'] + "</span></li> <li style=\"height:20px;\"><img src=\"images/mycross.png\" class=\"ui-li-icon ui-icon-check\"><span class=\"ui-li-count\">" + user['rejects'] + "</span></li> </ul></div></div> </div><div class=\"ui-grid-a\" style=\"border: solid 1px #cc0000\"> <div class=\"ui-block-a\" style=\"width:30%;\"><div class=\"ui-bar ui-bar-a namebar\" style=\" background-color:#ffbb00; color:#ffffff; text-shadow:none;\">" + user['name'] + "</div></div> <div class=\"ui-block-b\" style=\"width:70%;\"><div class=\"ui-bar ui-bar-a info\" style=\"background-color:#88ccc1; color:#ffffff; text-shadow:none;\"><div align=\"center\" class=\"float-left\">" + user['actvity'] + "</div><div align=\"center\" class=\"float-left\">" + user['time'] + "</div><div align=\"center\" class=\"float-left\">"  + "</div></div></div> </div> "
...
function getTableData() {
    console.log("http://evening-thicket-5124.herokuapp.com/credentialService/getMyPastTables?userid=" + $.session.get('userHash'))
    $.ajax(
            {
                url: "http://evening-thicket-5124.herokuapp.com/credentialService/getMyPastTables?userid=" + userid,
                async: false,
                dataType: "json",
